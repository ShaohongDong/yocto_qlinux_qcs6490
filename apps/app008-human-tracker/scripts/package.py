...
def main():
    ...
    parser.add_argument("--allow-untrained", action="store_true", help="Explicit development smoke bundle only")
    ...
    if not manifest.get("trained") and not args.allow_untrained:
        raise SystemExit("Refusing to package an untrained smoke model as a trained release")
