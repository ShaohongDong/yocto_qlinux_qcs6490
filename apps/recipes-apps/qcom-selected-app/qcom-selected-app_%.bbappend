...
inherit_defer ${@'pkgconfig' if d.getVar('QCOM_APP') in ('app002-imx708-camera', 'app003-hevc-benchmark', 'app004-ai-demo', 'app005-gpu-benchmark', 'app006-wifi-test', 'app008-human-tracker', 'app009-gesture-recognizer', 'app010-person-follow') else ''}
...
FILES:${PN}:append = "${@' ${datadir}/icons/hicolor/scalable/apps/human-tracker.svg' if d.getVar('QCOM_APP') == 'app008-human-tracker' else ''}"
...
FILES:${PN}:append = "${@' ${datadir}/icons/hicolor/scalable/apps/gesture-recognizer.svg' if d.getVar('QCOM_APP') == 'app009-gesture-recognizer' else ''}"

FILES:${PN}:append = "${@' ${datadir}/icons/hicolor/scalable/apps/person-follow.svg' if d.getVar('QCOM_APP') == 'app010-person-follow' else ''}"
