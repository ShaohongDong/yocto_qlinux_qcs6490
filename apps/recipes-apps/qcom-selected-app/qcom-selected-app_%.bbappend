...
inherit_defer ${@'pkgconfig' if d.getVar('QCOM_APP') in ('app002-imx708-camera', 'app003-hevc-benchmark', 'app004-ai-demo', 'app005-gpu-benchmark', 'app006-wifi-test', 'app008-human-tracker') else ''}
